...
class DocumentState(object):
  ...
  def finalize(self):
    ...
    all_mentions = [ment for cluster in merged_clusters for ment in cluster]
...
def minimize_partition(name, data, language, extension):
  input_path = "{}/{}.{}.{}".format(data, name, language, extension)
  output_path = "{}/{}.{}.jsonlines".format(data, name, language)
  count = 0
...
def minimize_language(language, data):
  minimize_partition("dev", data, language, "v4_auto_conll")
  minimize_partition("train", data, language, "v4_auto_conll")
  minimize_partition("test", data, language, "v4_gold_conll")

if __name__ == "__main__":
  minimize_language("english", "data/data")
